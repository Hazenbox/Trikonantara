    ...
    <section className="py-20 relative bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="reveal-element bg-pebble-lightBlue p-8 rounded-xl">
            <h3 className="text-2xl font-bold mb-4 text-pebble-darkBlue">
              Mission
            </h3>
            <p className="text-pebble-secondaryText">
