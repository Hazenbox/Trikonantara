...
const AboutSection: React.FC = () => {
  ...
  return (
    <section 
      id={sectionId}
      className="min-h-screen py-20 relative bg-[#1A2A5E] flex items-center opacity-0"
    >
      ...
      <div className="container mx-auto px-4 max-w-5xl about-container">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-center">
          ...
          <div className="about-left-col md:col-span-5">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-pebble-lightBeige font-funnel split-text">
              About Trikonantara
            </h2>
            
            <div className="about-text-wrapper">
              <p className="text-lg text-pebble-lightBeige/80 font-fustat mb-6 about-text">
                We redefine how people experience the world through pioneering AR and VR technology.
              </p>
              <p className="text-lg text-pebble-lightBeige/80 font-fustat about-text">
            ...
            <div className="mt-8">
              <Link
                to="/about"
                className="inline-flex items-center bg-pebble-lightBeige hover:bg-pebble-offWhite text-[#1A2A5E] py-3 px-8 rounded-full transition-all duration-300 shadow-lg shadow-black/20 hover:shadow-xl hover:scale-105 hover:translate-y-[-2px] group"
              >
                Explore Our Story
