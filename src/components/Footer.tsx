    ...
    <footer className="bg-[#0b2d5f] bg-opacity-90 py-16">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="text-lg font-semibold mb-6 relative inline-block text-white">
              <span>Quick Links</span>
              <span className="absolute bottom-0 left-0 w-1/2 h-0.5 bg-lightblue-500"></span>
            </h4>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <Mail size={18} className="text-lightblue-500 mt-1" />
                <span className="text-gray-300">info@trikonantara.com</span>
              </div>
              <div className="flex items-start space-x-3">
                <Phone size={18} className="text-lightblue-500 mt-1" />
...
const SocialIcon: React.FC<SocialIconProps> = ({ icon, href }) => {
  return (
    <a
      href={href}
      className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-700 text-gray-300 hover:bg-lightblue-500 hover:text-white transition-all duration-300"
      target="_blank"
